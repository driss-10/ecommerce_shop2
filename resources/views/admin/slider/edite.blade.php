                            ...
                            <form method="POST" action="" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  name="button_name"  placeholder="Enter Button Name" value="{{$getRecord->button_name}}"  >
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  name="button_link"  placeholder="Enter Button Link" value="{{$getRecord->button_link}}"  >
                                    </div>
